...
('mfindel@vp-felder.de', crypt('hommes', gen_salt('bf')), 1000, 1, now() - interval '2 hours'),
('chauser@vp-felder.de', crypt('hauser', gen_salt('bf')), 3000, 0, now() - interval '3 years'),
('c_karasius@fondshaus.ag', crypt('supersicher', gen_salt('bf')), 2000, 1, NULL);
...
('kari@example.com', crypt('bremnes', gen_salt('bf')), 'D5F449CE', 1, now() - interval '2 hours'),
('ane@example.net', crypt('brun', gen_salt('bf')), 'E97DEF37', 1, now()),
('sezen@example.net', crypt('aksu', gen_salt('bf')), '80BA9796', 1, NULL),
('eleftheria@example.net', crypt('arvanitaki', gen_salt('bf')), '80B4F645', 0, now() - interval '3 days'),
('ebba@example.net', crypt('forsberg', gen_salt('bf')), NULL, 1, now());
